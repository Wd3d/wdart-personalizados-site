async function loadConfig(){
  ...
  const badges=document.getElementById('hero-badges'); badges.innerHTML=''; (cfg.hero.badges||[]).forEach(b=>{const s=document.createElement('span'); s.textContent=b; badges.appendChild(s);});
